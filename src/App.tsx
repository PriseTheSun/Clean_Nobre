      ...
      <div className="lg:grid lg:grid-cols-2 lg:gap-12 items-center">
        ...
        >
          ...
          <p className="text-lg text-lavender-grey mb-10 max-w-lg">
            A CleanNobre cuida das suas peças com o carinho que elas merecem. Tecnologia de ponta e entrega rápida para você aproveitar o que realmente importa.
          </p>
      ...
      <div className="lg:grid lg:grid-cols-2 lg:gap-20 items-center">
        ...
        <div>
          ...
          <p className="text-lavender-grey mb-8 leading-relaxed">
            A CleanNobre nasceu da necessidade de oferecer um serviço de lavanderia que unisse a confiança do cuidado artesanal com a eficiência da tecnologia moderna. Localizada no coração da cidade, somos referência em sustentabilidade e qualidade.
          </p>
...
const Testimonials = () => {
  const reviews = [
    { name: 'Mariana Silva', role: 'Anfitriã de Airbnb (Alta Demanda)', text: 'O serviço de lavagem a seco é impecável. Meus enxovais parecem novos toda vez que voltam da CleanNobre.', stars: 5 },
...
export default function App() {
  ...
  const termsContent = (
    <>
      <p>Bem-vindo à CleanNobre. Ao utilizar nossos serviços, você concorda com os seguintes termos:</p>
      <h2 className="text-xl font-bold text-space-indigo mt-8">1. Serviços</h2>
      <p>A CleanNobre oferece serviços de lavanderia, passadoria e limpeza especializada. Reservamo-nos o direito de recusar peças que apresentem riscos à integridade de nossos equipamentos ou de outras peças.</p>
  ...
  return (
    <div className="min-h-screen selection:bg-punch-red selection:text-white">
      ...
      <footer className="py-12 bg-platinum border-t border-lavender-grey/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-8">
            ...
            <p className="text-sm text-lavender-grey">
              © 2026 CleanNobre. Todos os direitos reservados.
            </p>
            <div className="flex gap-8">
              <button onClick={() => setActiveLegal('terms')} className="text-xs text-lavender-grey hover:text-punch-red">Termos de Uso</button>
              <button onClick={() => setActiveLegal('privacy')} className="text-xs text-lavender-grey hover:text-punch-red">Privacidade</button>
            </div>
          </div>
        </div>
      </footer>
